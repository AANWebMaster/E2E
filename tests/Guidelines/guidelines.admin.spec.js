...
test('Test generating a guideline report', async ({ page }) => {
    ...
    // Click text=Guideline Views Start Date End Date Topics Brain Injury and Brain Death Child Ne >> button[name="save"]
    await page.locator('text=Guideline Views Start Date End Date >> button[name="save"]').click();
